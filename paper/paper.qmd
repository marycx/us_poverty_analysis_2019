...
## Data Measurement
The data is mainly collected by surveys. Portions of SPM resources, such as values of taxes and some non-cash benefits, are not asked of respondents and are estimated using models. The models takes in administrative data where appropriate to ensure that the estimated amounts reflect external totals and distributions [@spm].
