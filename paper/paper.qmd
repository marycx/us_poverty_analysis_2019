...
poverty2019 <-
  ...
  select(poverty_status, marital_status, income, age)
```
...
```{r}
#| label: fig-mortgage
#| fig-cap: The distribution of poverty status by marital status
#| echo: false
#| warning: false
#| message: false
poverty2019 |>
  ggplot(aes(x = marital_status, fill = poverty_status)) +
...
```{r}
#| label: fig-age
#| fig-cap: The distribution of poverty status by age group
#| echo: false
#| warning: false
#| message: false
poverty2019 |>
  ggplot(aes(x = age, fill = poverty_status)) +
  geom_bar(position = "dodge") +
  coord_flip() +
  theme_minimal() +
  scale_fill_brewer(palette = "Set1") +
...
#| fig-subcap: ["Trace plot of Intercept", "Trace plot of Married - civilian spouse present", "Trace plot of Married - armed forces spouse present", "Trace plot of Married - spouse absent (excluding separated)", "Trace plot of Widowed", "Trace plot of Separated", "Trace plot of Never Married"]
#| layout-ncol: 2

plot(poverty_prediction_model, "trace", "(Intercept)")
plot(poverty_prediction_model, "trace", "marital_statusMarried - armed forces spouse present")
plot(poverty_prediction_model, "trace", "marital_statusMarried - civilian spouse present")
plot(poverty_prediction_model, "trace", "marital_statusMarried - spouse absent (excluding separated)")
plot(poverty_prediction_model, "trace", "marital_statusNever Married")
plot(poverty_prediction_model, "trace", "marital_statusSeparated")
plot(poverty_prediction_model, "trace", "marital_statusWidowed")
```
...
plot(poverty_prediction_model, "rhat") + xlim(-100,1.1)
```
```{r}
#| echo: false
#| eval: true
